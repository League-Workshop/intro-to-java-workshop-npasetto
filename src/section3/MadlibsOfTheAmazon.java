...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"If you find yourself having to cross a piranha-infested river, here is how to do it...");
		// Get the user to enter an adjective
		String adjective = JOptionPane.showInputDialog("Please enter an adjective.");
		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Input a type of liquid.");
		// Get the user to enter a body part
		String bodyPart = JOptionPane.showInputDialog("Input a body part.");
		// Get the user to enter a verb
		String verb = JOptionPane.showInputDialog("Input a verb.");
		// Get the user to enter a place
		String place = JOptionPane.showInputDialog("Input a place.");
