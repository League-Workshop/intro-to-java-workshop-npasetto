...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		if (attack.equals("yell")) {
			...
			playerDamage = factory.nextInt(13);
		...
		if (attack.equals("kick")) {
			...
			playerDamage = factory.nextInt(26);
			//-- Subtract that number from the dragon's health variable
			dragonHealth = dragonHealth - playerDamage;
			
		}
		if (attack.equals("yell")) {
			dragonDamage = factory.nextInt(11);
		...
		// 14. Else if the dragon's health is less than or equal to 0
			...
			JOptionPane.showMessageDialog(null, "The dragon is dead and you took 7625597484927 gold.");
	   //  15.  Else
		}else {
